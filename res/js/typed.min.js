...
$(document).ready(function($) {
    //Types.js execution script
    var options = {
        strings: ["Beyond words", "Beyond pictures", "Beyond video"],
        loop: true,
        typeSpeed : 100,
    ...
    //Defining public-banner height
    var publicBannerHeight = $("#public-bgvid").height();
    var $window = $(window).on('resize', function(){
        $(".public-banner").height(publicBannerHeight);
    }).trigger('resize');
});
